...
import { LogIn, Mail, Lock, Loader2, Sparkles, AlertCircle, ArrowLeft } from 'lucide-react';
      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8 text-center">
          ...
          <h2 className="text-2xl font-black text-white tracking-tight">
            Connect to <span className="text-cyber-gradient">WaveFlow</span>
          </h2>
          <p className="text-[10px] uppercase font-extrabold tracking-widest text-zinc-500 mt-1">Audio Streaming Network Node</p>
        </div>
        ...
        <div className="glassmorphism p-8 rounded-3xl border border-zinc-800/60 shadow-2xl relative overflow-hidden">
          ...
          <div className="mt-6 pt-6 border-t border-zinc-800/40 text-center">
            <span className="text-[11px] text-zinc-550 font-medium">New terminal operator? </span>
            <Link
              href="/register"
